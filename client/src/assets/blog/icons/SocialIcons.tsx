...
// WhatsApp Icon Component - Official Green: #25D366
export const WhatsAppIcon: React.FC<SocialIconProps> = ({ size = 24, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="#25D366" {...props}>
...
// LinkedIn Icon Component - Official Blue: #0A66C2
export const LinkedInIcon: React.FC<SocialIconProps> = ({ size = 24, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="#0A66C2" {...props}>
