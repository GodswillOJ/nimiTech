...
const Blog = () => {
    ...
    return (
        <div className={styles.blogContainer}>
            ...
            <section className={styles.featuredPost} style={{ backgroundImage: `url(${featuredPost.image})` }}>
                            ...
                            <Link to={`/blogs/${post.id}`} className={styles.blogCardLink}>
                                ...
                                <div className={styles.contentContainer}>
                                    ...
                                    <div className={styles.metaInfo}>
                                        <img src={authorAvatar} alt={post.author.name} className={styles.authorAvatar} />
