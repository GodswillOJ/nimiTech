...
const ContactUs = () => {
  ...
  // SEO Configuration
  const seoData = {
    title: 'Contact Us - Get in Touch with Nimitech IT Experts Today',
    description:
      "Have questions or need assistance? Reach out to Nimitech IT today for personalized digital transformation solutions, IT consulting, and technology services. We're here to help you succeed!",
    keywords:
      'contact Nimi Tech, IT support, technology consultation, digital transformation help, get quote, IT services inquiry, contact form',
    canonical: 'https://nimitechit.com/contact-us',
    ogImage: 'https://nimitechit.com/images/contact-og-image.jpg',
    structuredData: {
      '@context': 'https://schema.org',
      '@type': 'ContactPage',
      name: 'Contact Nimi Tech',
      description: 'Get in touch with our IT experts for personalized solutions',
      url: 'https://nimitechit.com/contact-us',
      mainEntity: {
        '@type': 'Organization',
        name: 'Nimi Tech',
        contactPoint: {
          ...
          <Box width="100%" maxWidth="1200px" px={isSmallScreen ? 2 : 4}>
            <Grid container spacing={8}>
              <Box>
                ...
                >
                  Ready to transform your business? Contact Nimitech IT today and discover how our
                  IT solutions, digital marketing, and design expertise can help you outperform the
                  competition.
                </Typography>
              </Box>
                ...
                <Fade in timeout={1000}>
                  <Box>
                    ...
                    <Box display="flex" gap={3} mt={1}>
                      <a
                        href="https://x.com/Nimitechitinsta"
                        target="_blank"
                  ...
                  <Box>
                    <Box>
                      ...
                      <Typography
                        ...
                        sx={{ fontFamily: 'Montserrat, sans-serif' }}
                      >
                        Have a question about our services? Fill out the form below and we’ll get
                        ...
                        <FormControlLabel
                          ...
                          label={
                            <Typography variant="body2" fontFamily="Montserrat, sans-serif">
                              By checking this box, you agree to be contacted by Nimitech IT using
                              the information provided in this form. Your information will be used
