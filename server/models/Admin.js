...
// Mongoose automatically creates indexes for unique fields (email, username)
...
adminSchema.methods.incLoginAttempts = function () {
  ...
  // If already locked and lock hasn't expired
...
// Static method to create admin (for seeding)
